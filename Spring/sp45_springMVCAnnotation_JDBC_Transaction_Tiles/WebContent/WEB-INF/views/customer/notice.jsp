			...
			<h2>공지사항</h2>
					...
					<div id="pager-wrapper" class="margin-small">
						<div class="pager clear">
							...
							<ul>
								<li>
									<a class="strong" href="notice.htm?pg=1&f=${param.f}&q=${param.q}">1</a>
								</li>
								<li>
									<a href="notice.htm?pg=2&f=${param.f}&q=${param.q}">2</a>
								</li>
								<li>
									<a href="notice.htm?pg=3&f=${param.f}&q=${param.q}">3</a>
								</li>
								<li>
									<a href="notice.htm?pg=4&f=${param.f}&q=${param.q}">4</a>
								</li>
								<li>
									<a href="notice.htm?pg=5&f=${param.f}&q=${param.q}">5</a>
								</li>
							</ul>
							<p id="btnNext">
