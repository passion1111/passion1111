...
<c:set var="tdBgColor_odd" value="#E6F2FF"/>
<c:set var="tdFontColor_odd" value="white"/>

<c:set var="tdBgColor_even" value="#CAE4FF"/>
<c:set var="tdFontColor_even" value="white"/>
...
<style>
	...
	.tbcss0, .tbcss0 td, .tbcss0 th{ 
		...
		border:0px solid ${tableBorderColor};         /*padding:5;*/
		font-size: 9pt;
	...
	.tbcss1 th{ 
		background-color:${trBgColor_mouseover};
		color:${trBgColor_head};
	}
	.tbcss1 td{ 
	...
	.tbcss11 tr:nth-child(odd){ padding:5;background-color:${trBgColor_odd}; }
	.tbcss11 tr:nth-child(even){ padding:5;background-color:${trBgColor_even}; }  
