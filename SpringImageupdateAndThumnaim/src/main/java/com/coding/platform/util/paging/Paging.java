...
public class Paging {
	 ...
	 */
	public Paging(int currentPage, int totalCount,int pageRow) {
		...
		startPage = (int) ((currentPage - 1) / Constant.BLOCK_PAGE)
				* Constant.BLOCK_PAGE + 1;
		endPage = startPage + Constant.BLOCK_PAGE - 1;
