	...
	<div id="main">
		<form action="gwritePro.jsp" method="post">
			<table>
				<tr>
					<td>이름 </td>
					<td> <input type="text" name="name" placeholder="이름입력" required="required"> </td>
				</tr>
				<tr>
					<td>E-Mail</td>
					<td> <input type="email" name="email" placeholder="kosta@kosta.or.kr" > </td>
				</tr>
				<tr>
					<td>HomePage</td>
				...
				<tr>
					<td>내    용</td>
					<td> <textarea rows="15" cols="50" placeholder="글쓰기" name="contents" required="required"></textarea> </td>
				</tr>
