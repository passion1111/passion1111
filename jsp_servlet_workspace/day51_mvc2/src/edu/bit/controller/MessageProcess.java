...
public class MessageProcess extends HttpServlet	implements CommandProcess {
	...
	/*
	 * @Override public void doProcess(HttpServletRequest request,
	 ...
	 * 
	 * //4. 해당 뷰 페이지로 이동 RequestDispatcher dp =
	...
	protected void doGet(HttpServletRequest req, 
		...
		try {
//			doProcess(req, resp);
			RequestDispatcher dp=req.getRequestDispatcher(doProcess(req,resp));
			dp.forward(req, resp);
		} catch (Exception e) {
			e.printStackTrace();
		}
