...
Fac_status varchar2(10),
Fac_category varchar2(30)
);
select * from Facilities;
commit;
insert into Facilities values('6','승강기','1층','정상','전기');
--drop trigger FACILITIES_TRIGGER;


alter table  Facilities add (Fac_status varchar2(10),Fac_category varchar2(30));
