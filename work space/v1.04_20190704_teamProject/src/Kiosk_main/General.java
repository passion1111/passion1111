...
//		mainmenu(new Menupan(), menuchoose); //
	...
	void mainmenu(Menupan menupan, Menuchoose menuchoose) { //메인메뉴를 보여주고 주문번호를 받는 메서드
	...
	private void choosefood(Menu menu, Menuchoose menuchoose) { //주문번호 입력완료시 수량입력받는 메서드
	...
	private void ordermorefood(Menuchoose menuchoose) { //추가주문메서드
...
//			}
	...
	private void cancelmenu(Menuchoose menuchoose) {//메뉴 수량만큼 입력받아서 취소하는 메서드
