...
public class Inventory_JM {
	...
	private void makeedit() throws InterruptedException, ClassNotFoundException, SQLException { ////재고관리 선택 메소드.
...
public void select(PreparedStatement pstmt, Connection conn) throws SQLException {
