...
<!-- 게시판 수정 -->
		<table cellpadding="0" cellspacing="0">
			...
			<!-- 제목 -->
				<td style="font-family: 돋음; font-size: 12">${vo.tra_subject }</td>
			</tr>
			...
			<tr>
				...
				<c:if test="${vo.tra_filename!=null }">  <!-- 파일네임이 널이 아니면. -->
						<a href="FileDownload.do?file_name=${vo.tra_filename}"> <!-- 파일을 다운로드할수있게. -->
							${vo.tra_filename } </a>
					</c:if></td>
			</tr>
			...
			<tr align="right" valign="middle">
				<td colspan="5"><font size=2>
							...
							<a href="./TradeBoardModifyFormAction.do?num=${vo.tra_num }">	[수정] </a>&nbsp;&nbsp;
			<a href="./TradeBoardDeleteAction.do?num=${vo.tra_num}"> [삭제] </a>&nbsp;&nbsp;
			 </c:if> 
			 <a href="./list.do">[목록]</a>&nbsp;&nbsp;
				</font>
				</td>
